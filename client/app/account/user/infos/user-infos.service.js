        ...
        this.getCreationRules = function (params) {
            ...
            return $http
                ...
                .then((returnResponse) =>
                    ...
                    // Get corporation Type by country
                    $http
                        ...
                        .then(
                            (response) => {
                                returnResponse.availableCorporationType = response.data;
                                return returnResponse;
                            },
                            () => {
                                returnResponse.availableCorporationType = null;
                                return returnResponse;
                            }
                        )
                )
                .then((returnResponse) =>
                    ...
                    $http
                        ...
                        .then(
                            (response) => {
                                returnResponse.availableLegalform = response.data;
                                return returnResponse;
                            },
                            () => {
                                returnResponse.availableLegalform = null;
                                return returnResponse;
                            }
                        )
                )
                .then((returnResponse) =>
                    ...
                    $http
                        ...
                        .then(
                            (response) => {
                                returnResponse.availableArea = response.data;
                                return returnResponse;
                            },
                            () => {
                                returnResponse.availableArea = null;
                                return returnResponse;
                            }
                        )
                )
                .then((returnResponse) =>
                    $http.get([constants.swsProxyRootPath, "newAccount.json"].join("")).then(
                        (response) => {
                            returnResponse.availableGender = response.data.models["nichandle.GenderEnum"].enum;
                            return returnResponse;
                        },
                        () => {
                            returnResponse.availableGender = [];
                            return returnResponse;
                        }
                    )
                );
